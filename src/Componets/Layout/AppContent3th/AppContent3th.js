...
import { Layout, Form, Input, Upload, Checkbox, Typography, Space, Row } from 'antd';
  ...
  return (
    <Content style={{ padding: '0 24px', width: '100%', maxWidth: '100%', overflow: 'hidden' }}>
      <Space direction="vertical" size="large" style={{ display: 'flex', width: '100%' }}>
        <div style={{ width: '100%' }}>
          <Title level={4} style={{ fontWeight: 'bold', margin: 0 }}>Add New Payout Account</Title>
        ...
        <Text>All fields marked with <span style={{ color: 'red' }}>*</span> are mandatory.</Text>
        <Form
          form={form}
          layout="horizontal"
          onFinish={onFinish}
          ...
          >
            <Upload name="savingsBook" action="/upload.do" listType="picture">
              <Space>
                ...
                <span style={{ fontWeight: 'bold' }}>First page savings book</span>
              </Space>
            </Upload>
          </Form.Item>
